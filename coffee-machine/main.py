...
def check_resources(ingredients, resources):
    ...
    enough_water = ingredients.get('water') <= resources.get('water')
    enough_milk = ingredients.get('milk') <= resources.get('milk')
    enough_coffee = ingredients.get('coffee') <= resources.get('coffee')
